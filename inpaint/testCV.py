...
cv2.imwrite("C:\\Users\\28340\\Documents\\UCL\\internship\\2ndYear\\summerResearch\\generative_inpainting-master (1)\\generative_inpainting-master\\examples\\tempText3.png", tempImage)
cv2.imwrite("C:\\Users\\28340\\Documents\\UCL\\internship\\2ndYear\\summerResearch\\generative_inpainting-master (1)\\generative_inpainting-master\\examples\\maskText3.png", res)
cv2.rectangle(input, refPt[0], refPt[1], (255,255,255), -1)
cv2.imwrite("C:\\Users\\28340\\Documents\\UCL\\internship\\2ndYear\\summerResearch\\generative_inpainting-master (1)\\generative_inpainting-master\\examples\\inputText3.png",input)
...
# 	pass
# if model ==2:
os.system("python test.py --image examples\inputText3.png --mask examples\maskText3.png --output examples\inputText3.png --checkpoint logs/pretrain_model")
